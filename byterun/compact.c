...
extern void caml_shrink_heap_r (pctxt,char *);              /* memory.c */
...
static void init_compact_allocate_r (pctxt ctx)
{
...
static char *compact_allocate_r (pctxt ctx, mlsize_t size)
                                      /* in bytes, including header */
{
  char *chunk, *adr;
...
static void do_compaction_r (pctxt ctx)
{
  char *ch, *chend;
...
void caml_compact_heap_r (pctxt ctx)
{
  uintnat target_words, target_size, live;
