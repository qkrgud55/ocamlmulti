...
external remove : string -> unit = "caml_sys_remove_r" "reentrant"
(** Remove the given file name from the file system. *)

external rename : string -> string -> unit = "caml_sys_rename_r" "reentrant"
...
external command : string -> int = "caml_sys_system_command_r" "reentrant"
(** Execute the given shell command and return its exit code. *)

external time : unit -> float = "caml_sys_time_r" "reentrant"
(** Return the processor time, in seconds, used by the program
   since the beginning of execution. *)

external chdir : string -> unit = "caml_sys_chdir_r" "reentrant"
(** Change the current working directory of the process. *)

external getcwd : unit -> string = "caml_sys_getcwd_r" "reentrant"
(** Return the current working directory of the process. *)

external readdir : string -> string array = "caml_sys_read_directory_r" "reentrant"
...
external signal :
  int -> signal_behavior -> signal_behavior = "caml_install_signal_handler_r" "reentrant"
