...
external of_float : float -> int64 = "caml_int64_of_float_r" "reentrant"
(** Convert the given floating-point number to a 64-bit integer,
   discarding the fractional part (truncate towards 0).
   The result of the conversion is undefined if, after truncation,
   the number is outside the range \[{!Int64.min_int}, {!Int64.max_int}\]. *)

external to_float : int64 -> float = "caml_int64_to_float_r" "reentrant"
...
external of_string : string -> int64 = "caml_int64_of_string_r" "reentrant"
...
external bits_of_float : float -> int64 = "caml_int64_bits_of_float_r" "reentrant"
...
external format : string -> int64 -> string = "caml_int64_format_r" "reentrant"
